...
static void ShowDemoWindowPopups()
{
    ...
    if (ImGui::TreeNode("Modals"))
    {
        ...
        if (ImGui::BeginPopupModal("Stacked 1", NULL, ImGuiWindowFlags_MenuBar))
        {
            ...
            if (ImGui::Button("AddResource another modal.."))
...
void ImGui::ShowFontSelector(const char* label)
{
    ...
    HelpMarker(
        ...
        "- If you need to add/remove fonts at runtime (e.g. for DPI change), do it before calling Begin().");
}
...
struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        if (ImGui::SmallButton("AddResource Debug Text"))  { AddLog("%d some text", Items.Size); AddLog("some more text"); AddLog("display very important message here!"); }
        ImGui::SameLine();
        if (ImGui::SmallButton("AddResource Debug Error")) { AddLog("[error] something went wrong"); }
        ImGui::SameLine();
...
static void ShowExampleAppLog(bool* p_open)
{
    ...
    if (ImGui::SmallButton("[Debug] AddResource 5 entries"))
    {
        static int counter = 0;
...
static void ShowExampleAppLongText(bool* p_open)
{
    ...
    ImGui::SameLine();
    if (ImGui::Button("AddResource 1000 lines"))
    {
